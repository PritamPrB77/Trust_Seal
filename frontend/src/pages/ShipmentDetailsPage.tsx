...
import { useShipment, useShipmentCustody, useShipmentLegs } from '@/hooks/useShipments';
...
function ShipmentDetailsPage() {
  ...
  const loading = shipmentLoading || legsLoading || custodyLoading || deviceLoading;
  const hasError = shipmentError || legsError || custodyError;
